...
const CHAT_SERVICE_URL = process.env.CHAT_SERVICE_URL || "localhost:8081";
...
router.ws('/chat/:group/:user', (ws, req) => {
  ...
  const chat_ws = new WebSocket(`ws://${CHAT_SERVICE_URL}/${CHAT_SERVICE_API_VERSION}/messages/${group}?user=${user}`);
